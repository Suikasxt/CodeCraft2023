...
extern double map_dist_main[2][50][50*MAP_SCALE][50*MAP_SCALE];
extern pair<int, int> map_target_main[2][50][50*MAP_SCALE][50*MAP_SCALE];
extern double studio_dist_main[50][50];
extern Point studio_dist_addition_main[50][50];
